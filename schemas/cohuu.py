...
class CohuuCreateWithDonvi(CohuuBase):
    ngaysinh: str | None = Field(default=None)
    CCCD_ngay: str | None = Field(default=None)
    email: str | None = Field(default=None)
    gioitinh: str | None = Field(default=None)
...
class CohuuReadWithDonvi(CohuuBase):
    id: int
    ngaysinh: str | None
...
class CohuuSearchWithDonvi(Base):
    id: int
...
class ListCohuuSearchWithDonvi(Base):
    data: List[CohuuSearchWithDonvi]
